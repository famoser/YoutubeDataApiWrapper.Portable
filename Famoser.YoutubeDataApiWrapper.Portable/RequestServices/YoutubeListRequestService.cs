...
using Famoser.YoutubeDataApiWrapper.Portable.Util.GoogleApiExtensions;
using Google.Apis.Requests;
using Google.Apis.YouTube.v3;

namespace Famoser.YoutubeDataApiWrapper.Portable.RequestServices
{
    /// <summary>
        ...
        where TResponseItem : class, IDirectResponseSchema
    {
        ...
        {
            if (ListRequestBuilder.GetType().GetRuntimeProperty(parameterName) == null)
            ...
            {
                ListRequestBuilder.GetType().GetRuntimeProperty(parameterName).SetValue(ListRequestBuilder, value);
